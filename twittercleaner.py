...
noRT = noAt.loc[(noAt['text'].str.startswith("RT")==False)]

#filter out twitter links (stealth retweets)

noLink = noRT.loc[(noRT['text'].str.contains("https://t.co/")==False)]

#filter out duplicates

dedup = noLink.drop_duplicates(subset=['text'])
